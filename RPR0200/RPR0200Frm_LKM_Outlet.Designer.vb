...
Partial Class RPR0200Frm_LKM_Outlet
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.LKM_OutletDTOBindingSource.DataSource = GetType(RPR0200.RPR0200SvcRef.LKM_OutletDTO)
        '
        ...
        Me.SC_ReturnLookUpAndFind1.TabIndex = 5
        '
        'SC_GridSearch1
        '
        ...
        Me.SC_GridSearch1.TabIndex = 4
        '
        'RPR0200Frm_LKM_Outlet
        '
